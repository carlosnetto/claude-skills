#!/bin/bash
# Install the brazil-iof-tax skill for Claude Code
#
# Usage:
#   bash install.sh
...
echo "It will activate when you work on IOF tax computation, FX taxation in Brazil,"
echo "or system design for Brazilian fintech compliance."
