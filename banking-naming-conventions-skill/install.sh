#!/bin/bash
# Install the banking-naming-conventions skill for Claude Code
#
# Usage:
#   bash install.sh
...
SKILL_NAME="banking-naming-conventions"
...
echo "It will automatically activate when you work on banking or fintech projects."
